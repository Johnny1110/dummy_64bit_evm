...
public class MockAccountBalance {
    ...
    private static final Map<String, Long> accountBalances = new HashMap<>();

    static {
        log.info("[MockBlockChain] Initializing MockAccountBalance");
        // 預設一些帳戶餘額
        accountBalances.put("0x0111111111111111", 1000000000L); // 1 ETH
        accountBalances.put("0x0222222222222222", 500000000L);  // 0.5 ETH
        accountBalances.put("0x0333333333333333", 300000000L);  // 0.3 ETH
    }

    public static long getBalance(String hexAddress) {
